...
import com.coinomi.core.coins.BulpcoinMain;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/BulpCoin/BulpCoin/releases";

    public static final String VERSION_URL = "https://bulp.ml//version";
    public static final String PARTNERS_URI = "https://bulp.ml//partner.json";
    public static final String SUPPORT_EMAIL = "adevcoin@gmail.com";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            new CoinAddress(BulpcoinMain.get(), new ServerAddress("node1.coindroid.org", 64562),
                    new ServerAddress("node1.coindroid.org", 64562))
    ...
    static {
        ...
        COINS_ICONS.put(CoinID.BULPCOIN_MAIN.getCoinType(), R.drawable.bulpcoin);


        COINS_BLOCK_EXPLORERS = new HashMap<>();
        COINS_BLOCK_EXPLORERS.put(CoinID.BULPCOIN_MAIN.getCoinType(), "http://explorer.bulp.ml/tx/%s");
    }
